...
async function request(reqUrl) {
    ...
    async function home(_inReq, _outResp) {
        const classes = [{'type_id':'dy','type_name':'电影'},{'type_id':'dsj','type_name':'电视剧'},{'type_id':'dm','type_name':'动漫'},{'type_id':'zy','type_name':'综艺'},{'type_id':'jlp','type_name':'纪录片'}];
        const filterObj = {};
